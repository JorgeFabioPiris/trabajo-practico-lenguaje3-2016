...
import static py.edu.facitec.mec.view.mov.FormMovimiento1.servCodigo;

/**
 *
 * @author Jorge Fabio
 */
public class FormMovimiento1 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormMovimiento1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormMovimiento1().setVisible(true);
            }
        });
    }
    ...
    private void obtenerServicios() {
        ...
        if(ser!=null){
            ...
            servUnitario.setText(Utilidad.formatoValor(ser.getValor_unitario()));
        }else{
    ...
    private void sumarColumnasTabla() {
        ...
        //la cual estaras manejando
            ...
            tfImpoTotal.setText(Utilidad.formatoValor(sumatoria));
        }
    }
    ...
    private void cargarTabla() {
        ...
        subtot = can*uni*1000;
        fila[4]=Utilidad.formatoValor(subtot);
